...
interface AddBPReadingProps {
  onBack: () => void;
  onSave?: (reading: BPReading) => void;
}

export function AddBPReading({ onBack, onSave }: AddBPReadingProps) {
  ...
  msOverflowStyle: 'none',
        ...
        <div className="px-5 pt-3 pb-4 flex items-center justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <h1 className="text-[34px] font-bold tracking-[0.37px] leading-tight">Add Blood Pressure Reading</h1>
          </div>
        </div>
        ...
        <div className="px-4 flex flex-col gap-3">
          ...
          <div className="bg-white rounded-[26px] p-5 shadow-sm">
            <label className="block">
              <div className="text-[13px] font-medium text-[#848484] tracking-[-0.08px] mb-2">
                Systolic
              </div>
              <div className="flex items-baseline gap-2">
                <input
                  ...
                  className="text-[34px] font-extralight tracking-[-1px] leading-none text-black bg-transparent outline-none w-full placeholder:text-[#c7c7cc]"
                />
                <span className="text-[17px] text-[#848484] tracking-[-0.43px]">mmHg</span>
              </div>
            </label>
          </div>
          ...
          <div className="bg-white rounded-[26px] p-5 shadow-sm">
            <label className="block">
              ...
              <input
                ...
                className="text-[17px] tracking-[-0.43px] text-black bg-transparent outline-none w-full placeholder:text-[#c7c7cc]"
              />
            </label>
          </div>
        </div>
        ...
        <div className="px-4 mt-6">
          <button
            ...
            disabled={!isValid}
            className={`w-full rounded-[26px] p-4 shadow-sm transition-opacity ${
              isValid
                ? 'bg-[#ff3b30] active:opacity-80'
                : 'bg-[#c7c7cc] opacity-50'
            }`}
          >
