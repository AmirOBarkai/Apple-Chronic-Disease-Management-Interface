interface HealthRecordsPickerProps {
  onBack: () => void;
  onSelectRecord: () => void;
}

export function HealthRecordsPicker({ onBack, onSelectRecord }: HealthRecordsPickerProps) {
  const records = [
    {
  ...
  msOverflowStyle: 'none',
        ...
        <div className="px-5 pb-4">
          <p className="text-[15px] text-[#848484] tracking-[-0.24px] leading-[1.4]">
            Select a record from your connected providers
          </p>
        </div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <p className="text-[13px] text-[#848484] tracking-[-0.08px] mt-1">
