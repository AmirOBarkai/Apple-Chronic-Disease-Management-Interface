...
export function DoctorQuestions({ onBack, document, isSaved, onSave, onUnsave, onViewSaved }: DoctorQuestionsProps) {
  ...
  msOverflowStyle: 'none',
        ...
        <div className="px-5 pt-3 pb-4 flex items-center justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <h1 className="text-[34px] font-bold tracking-[0.37px] leading-tight">Questions for your next doctor visit</h1>
          </div>
        </div>
        ...
        <div className="px-5 pb-4">
          <p className="text-[15px] text-[#848484] tracking-[-0.24px] leading-[1.4]">
            Here are a few questions you may want to ask based on this report.
          </p>
        </div>
              ...
              {questions.map((question, index) => (
                <button
                  ...
                  className={`w-full py-4 text-left active:opacity-60 transition-opacity ${
                    index < questions.length - 1 ? 'border-b border-[#e6e6e6]' : ''
                  }`}
                >
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full border-2 border-[#e6e6e6] flex-shrink-0 mt-0.5" />
                    <p className="flex-1 text-[17px] text-black tracking-[-0.43px] leading-[1.47]">
                      {question}
                    </p>
                  </div>
                </button>
            ...
            {!isSaved ? (
              ...
              >
                <div className="flex-1 text-left">
                  <span className="text-[17px] tracking-[-0.43px] text-black block">Save questions for later</span>
                  <span className="text-[13px] text-[#848484] tracking-[-0.08px] block mt-0.5">
                    Get reminded before your appointment
                  </span>
                </div>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="opacity-30 flex-shrink-0 ml-3">
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <span className="text-[13px] text-[#848484] tracking-[-0.08px] block mt-0.5">
                    Tap to remove from Questions for Your Next Visit
                  </span>
                </div>
              </button>
            )}
