...
export const medicalDocuments: Record<string, MedicalDocument> = {
  doc_01_abpm_report: {
    id: 'doc_01_abpm_report',
    title: '24-Hour Blood Pressure Monitor Results',
    short_summary: 'This report shows your blood pressure measurements taken automatically every 30 minutes over a full day and night while you wore a portable monitor.',
  ...
  doc_02_hypertension_letter: {
    id: 'doc_02_hypertension_letter',
    title: 'Hypertension Diagnosis Letter',
    short_summary: 'A letter from your doctor confirming your high blood pressure diagnosis and outlining your initial treatment plan.',
    long_summary: 'This letter documents your hypertension diagnosis based on multiple elevated blood pressure readings during recent visits. It explains why treatment is recommended, what your target blood pressure should be, and describes your personalized treatment plan including lifestyle changes and medications. Your doctor has written this to ensure you understand your diagnosis, the health risks of untreated high blood pressure, and the importance of following your treatment plan. This letter may also be useful for other healthcare providers or for your personal health records.',
    key_terms: [
      {
  ...
  doc_03_bp_trend_report: {
    id: 'doc_03_bp_trend_report',
    title: 'Blood Pressure Trend Summary',
    short_summary: 'A chart showing how your blood pressure measurements have changed over the past several weeks or months.',
  ...
  doc_04_hospital_discharge: {
    id: 'doc_04_hospital_discharge',
    title: 'Hospital Discharge Summary',
    short_summary: 'A summary of your recent hospital stay, including why you were admitted, what treatment you received, and instructions for continuing your care at home.',
  ...
  doc_05_discharge_instructions_htn: {
    id: 'doc_05_discharge_instructions_htn',
    title: 'High Blood Pressure Discharge Instructions',
    short_summary: 'Step-by-step instructions for managing your high blood pressure after leaving the hospital, including medications, lifestyle changes, and follow-up care.',
